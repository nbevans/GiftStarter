...
namespace Giftstarter.Bootstrap.Html {
    public static class MenuExtensions {
        public static IHtmlString MenuLink(this HtmlHelper htmlHelper, string linkText, string actionName, string controllerName, object routeValues = null, bool activeByControllerOnly = false) {
